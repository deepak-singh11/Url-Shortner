...
const CopyButton = ({slug}:SlugType) => {
    ...
    return (
        <div onClick={() => {
            ...
            className="px-3 py-1 text-black border-gray-300 border bg-gray-200 w-full rounded flex justify-center items-center gap-2 hover:bg-gray-300 h-fit cursor-pointer">
